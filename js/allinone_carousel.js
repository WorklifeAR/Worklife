...
(function(c) {
    ...
    function z(a, b, h, l, f, k, p, u, g) {
        ...
        var d, j, n, q;
        "true" == c(f[h.current_img_no]).attr("data-video") && (c("#contentHolderUnit_" + h.current_img_no, k).html(c(f[h.current_img_no]).html()),
        b.responsive && b.width != b.origWidth && E(c("#contentHolderUnit_" + h.current_img_no, k), 0, b, h));
        ...
        for (m = 1; m <= Math.floor(b.numberOfVisibleItems / 2); m++)
            h.currentZ_index--,
            v = B(v, -1, p),
            h.currentImg = c("#contentHolderUnit_" + v, k),
            h.currentImg.css("z-index", h.currentZ_index),
            m == Math.floor(b.numberOfVisibleItems / 2) && (1 === a ? (last_aux_img_no = B(v, -1, p),
            last_currentImg = c("#contentHolderUnit_" + last_aux_img_no, k),
            j = b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - 2 * (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width),
            d = parseInt(j * h.aspectOrig, 10),
            n = parseInt((b.width - b.contentHolderUnitOrigWidth / (b.origWidth / b.width)) / 2, 10) - (m + 1) * b.elementsHorizontalSpacing / (b.origWidth / b.width),
            q = parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) - b.verticalAdjustment / (b.origWidth / b.width) + (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width),
            C(last_currentImg, n, q, d, j, 0, !1, a, h, b, g, f, p, u, l, k)) : (j = b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - 2 * (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width),
            parseInt(j * h.aspectOrig, 10),
            E(h.currentImg, m + 1, b, h),
            n = parseInt((b.width - b.contentHolderUnitOrigWidth / (b.origWidth / b.width)) / 2, 10) - (m + 1) * b.elementsHorizontalSpacing / (b.origWidth / b.width),
            q = parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) - b.verticalAdjustment / (b.origWidth / b.width) + (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width),
            h.currentImg.css({
                left: n + "px",
            ...
            j = b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - 2 * m * b.elementsVerticalSpacing / (b.origWidth / b.width),
            d = parseInt(j * h.aspectOrig, 10),
            n = parseInt((b.width - b.contentHolderUnitOrigWidth / (b.origWidth / b.width)) / 2, 10) - m * b.elementsHorizontalSpacing / (b.origWidth / b.width),
            q = parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) - b.verticalAdjustment / (b.origWidth / b.width) + m * b.elementsVerticalSpacing / (b.origWidth / b.width),
            C(h.currentImg, n, q, d, j, 1, !1, a, h, b, g, f, p, u, l, k);
        ...
        for (m = 1; m <= Math.floor(b.numberOfVisibleItems / 2); m++)
            ...
            h.currentImg = c("#contentHolderUnit_" + v, k),
            h.currentImg.css("z-index", h.currentZ_index),
            m == Math.floor(b.numberOfVisibleItems / 2) && (1 === a ? (E(h.currentImg, m + 1, b, h),
            h.currentImg.css({
                ...
                opacity: 0
            })) : (last_aux_img_no = B(v, 1, p),
            last_currentImg = c("#contentHolderUnit_" + last_aux_img_no, k),
            j = b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - 2 * (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width),
            d = parseInt(j * h.aspectOrig, 10),
            n = parseInt((b.width - b.contentHolderUnitOrigWidth / (b.origWidth / b.width)) / 2, 10) + (b.contentHolderUnitOrigWidth / (b.origWidth / b.width) + (m + 1) * b.elementsHorizontalSpacing / (b.origWidth / b.width) - d),
            q = parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) - b.verticalAdjustment / (b.origWidth / b.width) + (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width),
            C(last_currentImg, n, q, d, j, 0, !1, a, h, b, g, f, p, u, l, k))),
            h.currentImg.css("display", "block"),
            j = b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - 2 * m * b.elementsVerticalSpacing / (b.origWidth / b.width),
            d = parseInt(j * h.aspectOrig, 10),
            n = parseInt((b.width - b.contentHolderUnitOrigWidth / (b.origWidth / b.width)) / 2, 10) + (b.contentHolderUnitOrigWidth / (b.origWidth / b.width) + m * b.elementsHorizontalSpacing / (b.origWidth / b.width) - d),
            q = parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) - b.verticalAdjustment / (b.origWidth / b.width) + m * b.elementsVerticalSpacing / (b.origWidth / b.width),
            m == Math.floor(b.numberOfVisibleItems / 2) ? C(h.currentImg, n, q, d, j, 1, !0, a, h, b, g, f, p, u, l, k) : C(h.currentImg, n, q, d, j, 1, !1, a, h, b, g, f, p, u, l, k)
    }
    function E(a, b, c, l) {
    ...
    function C(a, b, h, l, f, k, p, u, g, d, j, n, q, v, w, r) {
        ...
        a.animate({
            ...
            if (p) {
                ...
                g.timeElapsed = 0;
                d.showCircleTimer && (clearInterval(g.intervalID),
                g.ctx.clearRect(0, 0, g.canvas.width, g.canvas.height),
                g.ctx.beginPath(),
                g.ctx.globalAlpha = d.behindCircleAlpha / 100,
                g.ctx.arc(d.circleRadius + 2 * d.circleLineWidth, d.circleRadius + 2 * d.circleLineWidth, d.circleRadius, 0, 2 * Math.PI, !1),
                g.ctx.lineWidth = d.circleLineWidth + 2,
                g.ctx.strokeStyle = d.behindCircleColor,
                g.ctx.stroke(),
                g.ctx.beginPath(),
                g.ctx.globalAlpha = d.circleAlpha / 100,
                g.ctx.arc(d.circleRadius + 2 * d.circleLineWidth, d.circleRadius + 2 * d.circleLineWidth, d.circleRadius, 0, 0, !1),
                g.ctx.lineWidth = d.circleLineWidth,
                g.ctx.strokeStyle = d.circleColor,
                g.ctx.stroke(),
                g.intervalID = setInterval(function() {
                    F(g, d)
                }, 125),
                cLeftPos = c("#contentHolderUnit_" + g.current_img_no, r).css("left"),
                cTopPos = c("#contentHolderUnit_" + g.current_img_no, r).css("top"),
                c(".mycanvas", r).css({
                    display: "block",
                ...
                if (0 < d.autoPlay && 1 < q && !g.mouseOverBanner && !g.fastForwardRunning || g.current_img_no != g.img_no_where_to_stop && g.fastForwardRunning)
                    clearTimeout(g.timeoutID),
                    g.timeoutID = setTimeout(function() {
                        z(u, d, g, w, n, r, q, v, j)
                    }, 1E3 * d.autoPlay);
                g.current_img_no == g.img_no_where_to_stop && g.fastForwardRunning && (g.fastForwardRunning = !1,
                d.animationTime = g.animationTimeOrig,
                d.autoPlay = g.autoPlayOrig)
            }
        });
    ...
    function I(a, b, c, l, f, k, p, u, g) {
        -1 === c.current_img_no - a ? z(1, b, c, l, f, k, p, u, g) : 1 === c.current_img_no - a ? z(-1, b, c, l, f, k, p, u, g) : (c.fastForwardRunning = !0,
        b.animationTime = 0.4,
        b.autoPlay = 0.1,
        c.img_no_where_to_stop = a,
        c.current_img_no < a ? a - c.current_img_no < p - a + c.current_img_no ? z(1, b, c, l, f, k, p, u, g) : z(-1, b, c, l, f, k, p, u, g) : c.current_img_no > a && (c.current_img_no - a < p - c.current_img_no + a ? z(-1, b, c, l, f, k, p, u, g) : z(1, b, c, l, f, k, p, u, g)))
    }
    function J() {
        var a = -1;
    ...
    c.fn.allinone_carousel = function(a) {
        ...
        return this.each(function() {
            ...
            g.css("display", "none");
            d.css("display", "none");
            a.showNavArrows && a.showOnInitNavArrows && (g.css("display", "block"),
            d.css("display", "block"));
            var j = c(".bottomNav", f), n = c(".bottomNavLeft", f), q = c(".bottomNavRight", f), v;
            j.css("display", "block");
            n.css("display", "block");
            q.css("display", "block");
            j.css({
            ...
            a.showBottomNav || (j.css("display", "none"),
            n.css("display", "none"),
            q.css("display", "none"));
            a.showOnInitBottomNav || (j.css("left", "-5000px"),
            n.css("left", "-5000px"),
            q.css("left", "-5000px"));
            ...
            t.each(function() {
                ...
                e.currentImg.is("li") && (s++,
                x = c('<div class="contentHolderUnit" rel="' + (s - 1) + '" id="contentHolderUnit_' + (s - 1) + '">' + e.currentImg.html() + "</div>"),
                k.append(x),
                x.css("display", "none"),
                0 === a.contentHolderUnitOrigWidth && (a.contentHolderUnitOrigWidth = x.width(),
                a.contentHolderUnitOrigHeight = x.height(),
                ...
                "true" == c(t[e.current_img_no]).attr("data-video") && r.css("display", "block")) : s <= Math.ceil(a.numberOfVisibleItems / 2) && (e.currentZ_index--,
                E(x, s - 1, a, e),
                x.css({
                ...
                A = c('<div class="bottomNavButtonOFF" rel="' + (s - 1) + '"></div>'),
                j.append(A),
                B += parseInt(A.css("padding-left").substring(0, A.css("padding-left").length - 2), 10) + A.width(),
                K = parseInt((j.height() - parseInt(A.css("height").substring(0, A.css("height").length - 2))) / 2, 10),
            ...
            a.showCircleTimer && (cLeftPos = c("#contentHolderUnit_" + e.current_img_no, f).css("left"),
            cTopPos = c("#contentHolderUnit_" + e.current_img_no, f).css("top"),
            c(".mycanvas", f).css({
            ...
            for (m = 1; m <= Math.floor(a.numberOfVisibleItems / 2); m++)
                e.currentZ_index--,
                E(c("#contentHolderUnit_" + (s - m), f), m, a, e),
                c("#contentHolderUnit_" + (s - m), f).css({
            ...
            a.responsive && H(w, a);
            j.width(B);
            a.showOnInitBottomNav && (j.css("left", parseInt((f.width() - B) / 2, 10) + "px"),
            n.css("left", parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) - n.width() + "px"),
            q.css("left", parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) + j.width() + parseInt(A.css("padding-left").substring(0, A.css("padding-left").length - 2), 10) + "px"));
            ...
            f.mouseenter(function() {
                ...
                a.autoHideNavArrows && a.showNavArrows && (g.css("display", "block"),
                d.css("display", "block"));
            ...
            f.mouseleave(function() {
                e.mouseOverBanner = !1;
                nowx = (new Date).getTime();
                a.autoHideNavArrows && a.showNavArrows && (g.css("display", "none"),
                d.css("display", "none"));
                a.autoHideBottomNav && a.showBottomNav && (j.css("display", "none"),
                n.css("display", "none"),
                q.css("display", "none"));
            ...
            x.click(function() {
                if (!e.slideIsRunning && !e.fastForwardRunning) {
                    ...
                    b != e.current_img_no ? (e.isVideoPlaying = !1,
                    c(y[e.current_img_no]).removeClass("bottomNavButtonON"),
                    I(parseInt(b, 10), a, e, y, t, f, s, r, w)) : "true" == c(t[e.current_img_no]).attr("data-video") ? (r.css("display", "none"),
                    C = c(this).find("img:first"),
                    C.css("display", "none"),
                    e.isVideoPlaying = !0) : void 0 != c(t[e.current_img_no]).attr("data-link") && ("" != c(t[e.current_img_no]).attr("data-link") && !e.effectIsRunning && !D) && (b = a.target,
                    void 0 != c(t[e.current_img_no]).attr("data-target") && "" != c(t[e.current_img_no]).attr("data-target") && (b = c(t[e.current_img_no]).attr("data-target")),
                    "_blank" == b ? window.open(c(t[e.current_img_no]).attr("data-link")) : window.location = c(t[e.current_img_no]).attr("data-link"))
                }
            });
            r.click(function() {
            ...
            g.mousedown(function() {
                D = !0;
                !e.slideIsRunning && !e.fastForwardRunning && (e.isVideoPlaying = !1,
                clearTimeout(e.timeoutID),
                z(-1, a, e, y, t, f, s, r, w))
            });
            g.mouseup(function() {
            ...
            y.mousedown(function() {
                ...
                if (!e.slideIsRunning && !e.fastForwardRunning) {
                    ...
                    b != e.current_img_no && (e.isVideoPlaying = !1,
                    c(y[e.current_img_no]).removeClass("bottomNavButtonON"),
                    I(parseInt(b, 10), a, e, y, t, f, s, r, w))
                }
            });
            y.mouseup(function() {
                D = !1
            ...
            y.mouseenter(function() {
                var b = c(this)
                  , e = b.attr("rel");
                a.showPreviewThumbs && (v = c('<div class="bottomOverThumb"></div>'),
                b.append(v),
                e = c(t[e]).attr("data-bottom-thumb"),
                v.html('<img src="' + e + '">'));
            ...
            f.wrap('<div id="carouselParent_' + h + '" style="position:relative;" />'),
            ...
            f.draggable({
                ...
                stop: function() {
                    e.effectIsRunning || (finalLeft = c(this).css("left"),
                    direction = 1,
                    origLeft < finalLeft && (direction = -1),
                    z(direction, a, e, y, t, f, s, r, w));
                    0 > rightVal && (d.css({
                        right: rightVal + "px",
                        visibility: "visible"
                    }),
            ...
            c(window).resize(function() {
                var d = J();
                doResizeNow = !0;
                -1 != navigator.userAgent.indexOf("Android") && (0 == a.windowOrientationScreenSize0 && 0 == window.orientation && (a.windowOrientationScreenSize0 = c(window).width()),
                0 == a.windowOrientationScreenSize90 && 90 == window.orientation && (a.windowOrientationScreenSize90 = c(window).height()),
                0 == a.windowOrientationScreenSize_90 && -90 == window.orientation && (a.windowOrientationScreenSize_90 = c(window).height()),
                a.windowOrientationScreenSize0 && (0 == window.orientation && c(window).width() > a.windowOrientationScreenSize0) && (doResizeNow = !1),
                a.windowOrientationScreenSize90 && (90 == window.orientation && c(window).height() > a.windowOrientationScreenSize90) && (doResizeNow = !1),
                a.windowOrientationScreenSize_90 && (-90 == window.orientation && c(window).height() > a.windowOrientationScreenSize_90) && (doResizeNow = !1),
                0 == e.windowWidth && (doResizeNow = !1,
                e.windowWidth = c(window).width()));
                -1 != d && (9 == d && 0 == e.windowWidth) && (doResizeNow = !1);
                e.windowWidth == c(window).width() ? (doResizeNow = !1,
                ...
                doResizeNow = !0)) : e.windowWidth = c(window).width();
                a.responsive && doResizeNow && (!1 !== G && clearTimeout(G),
                G = setTimeout(function() {
                    var d = a
                      ...
                      , v = y;
                    r.css("display", "none");
                    d.enableTouchScreen ? (responsiveWidth = b.parent().parent().parent().width(),
                    ...
                    d.responsiveRelativeToBrowser && (responsiveWidth = c(window).width(),
                    responsiveHeight = c(window).height());
                    ...
                    if (d.origWidth != responsiveWidth || d.width100Proc)
                        ...
                        d.height100Proc || (d.height = d.width / e.bannerRatio),
                        ...
                        k.width(d.width),
                        k.height(d.height),
                        d.enableTouchScreen && (f.parent().width(d.width + 1),
                        f.parent().height(d.height)),
                        p.css("margin-top", parseInt((d.height - g.height()) / 2, 10) + d.nextPrevMarginTop / (d.origWidth / d.width) + "px"),
                        j.css("left", parseInt((f.width() - j.width()) / 2, 10) + "px"),
                        n.css("left", parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) - n.width() + "px"),
                        q.css("left", parseInt(j.css("left").substring(0, j.css("left").length - 2), 10) + j.width() + parseInt(u.css("padding-left").substring(0, u.css("padding-left").length - 2), 10) + "px"),
                        r.css({
                        ...
                        w.css("top", parseInt(d.elementOrigTop / (d.origWidth / d.width), 10)),
                        clearTimeout(e.timeoutID),
            ...
            h = f.find("img:first");
            h[0].complete ? (c(".myloader", f).css("display", "none"),
            0 < a.autoPlay && 1 < s && (a.showCircleTimer && (e.arcInitialTime = (new Date).getTime(),
            e.timeElapsed = 0,
